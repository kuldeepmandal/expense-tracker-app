...
<div class="auth-split-layout">
    <div class="auth-left">
        ...
        <h1 style="font-size: 2rem; color: var(--text-primary); margin-bottom: 0.5rem; font-weight: 700;">Create your account</h1>
        ...
        <form method="POST" action="index.php?page=register" style="max-width: 400px;">
            ...
            <div class="auth-form-group">
                ...
                <div style="position: relative;">
                    ...
                    <button type="button" onclick="togglePasswordVisibility('registerPassword')"
                        ...
                        <svg id="registerPassword-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <div class="auth-form-group">
                ...
                <div style="position: relative;">
                    <input type="password" id="confirmPassword" name="confirm_password" class="auth-input" required
                        placeholder="••••••••">
                    <button type="button" onclick="togglePasswordVisibility('confirmPassword')"
                        style="position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--text-secondary); padding: 0;">
                        <svg id="confirmPassword-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            fill="currentColor" viewBox="0 0 256 256">
                            <path
                                d="M247.31,124.76c-.35-.79-8.82-19.58-27.65-38.41C194.57,61.26,162.88,48,128,48S61.43,61.26,36.34,86.35C17.51,105.18,9,124,8.69,124.76a8,8,0,0,0,0,6.48c.35.79,8.82,19.58,27.65,38.41C61.43,194.74,93.12,208,128,208s66.57-13.26,91.66-38.35c18.83-18.83,27.3-37.62,27.65-38.41A8,8,0,0,0,247.31,124.76ZM128,192c-30.78,0-57.67-11.19-79.93-33.25A133.47,133.47,0,0,1,25,128,133.33,133.33,0,0,1,48.07,97.25C70.33,75.19,97.22,64,128,64s57.67,11.19,79.93,33.25A133.46,133.46,0,0,1,231.05,128C223.84,141.46,192.43,192,128,192Zm0-112a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160Z">
                            </path>
            ...
            <p style="text-align: center; margin-top: 2rem; font-size: 0.8rem; color: var(--text-secondary);">
                By signing up, you agree to our <a href="#" style="color: var(--color-green-dark); font-weight: 600;">Terms</a> and <a
                    href="#" style="color: var(--color-green-dark); font-weight: 600;">Privacy Policy</a>.
            </p>
        </form>
    </div>
        ...
        <div class="auth-glass-widget">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                ...
                <div class="auth-glass-card" style="flex: 1;">
                    ...
                    <p style="font-size: 0.8rem; color: var(--text-muted); line-height: 1.5;">Understand your spending patterns with beautiful, easy-to-read charts.</p>
                </div>
            </div>
            ...
            <div class="auth-glass-card" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem 1.5rem; border-radius: 50px;">
                ...
                <div style="text-align: right;">
                    ...
                    <p style="margin: 0; font-size: 0.65rem; color: var(--text-muted); text-transform: uppercase; font-weight: bold;">Cash Payment</p>
                </div>
            </div>
        </div>
