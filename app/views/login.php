...
<div class="auth-split-layout">
    <div class="auth-left">
        ...
        <h1 style="font-size: 2rem; color: #0F172A; margin-bottom: 0.5rem; font-weight: 700;">Welcome back</h1>
        ...
        <form method="POST" action="index.php?page=login" style="max-width: 400px;">
            ...
            <div class="auth-form-group">
                ...
                <div style="position: relative;">
                    <input type="password" id="loginPassword" name="password" class="auth-input" required placeholder="••••••••">
                    <button type="button" onclick="togglePasswordVisibility('loginPassword')" style="position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #64748B; padding: 0;">
